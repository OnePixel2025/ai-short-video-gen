    ...
    history: [
        {
            role: "user",
            parts: [
                { text: "You are a video script generator. Always respond in English language only, regardless of the user's interface language or any other context. Never generate content in Arabic, Spanish, French, or any other language - only English.\n\nwrite a two different script for maximum 20 Seconds video on Topic:Kids Story,\n- Write ONLY in English language\n- Do not add Scene description\n- Do not Add Anything in Braces, Just return the plain story in text\n- Give me response in JSON format and follow the schema\n-{\n scripts:[\n {\n content:''\n },\n ],\n}\n" },
            ],
        },
        {
            role: "model",
    ...
    history: [
        {
            role: "user",
            parts: [
                { text: "You are an image prompt generator. Always respond in English language only, regardless of the user's interface language or any other context. Never generate content in Arabic, Spanish, French, or any other language - only English.\n\nGenerate Image prompt of Cinematic style with all deatils for each scene for maximum 20 seconds video : script: Rosa Parks refused to give up her seat on a bus in 1955. Her quiet act of defiance sparked the Montgomery Bus Boycott, a pivotal moment in the Civil Rights Movement. One person's bravery can inspire lasting change for everyone.\n\nIMPORTANT: Write image prompts ONLY in English language.\nJust Give specifing image prompt depends on the story line\n\ndo not give camera angle image prompt\n\nFollow the Folowing schema and return JSON data (Max 4-5 Images). JSON response Only\n\n[\n{\nimagePrompt:'',\nsceneContent: ' <Script Content>'\n}\n]" },
            ],
        },
        {
            role: "model",

...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row">
                ...
                <div className="max-w-md w-full space-y-6 sm:space-y-8">
                    <div>
                        <Image 
                            ...
                            className="mx-auto"
                        />
                        <h2 className="mt-4 sm:mt-6 text-2xl sm:text-3xl font-bold text-center text-white">Welcome back</h2>
            ...
            {/* Right Side - Image */}
            <div className="w-full md:w-1/2 bg-gradient-to-r from-[#FFE03A] to-[#EFFB53] hidden md:block">
